...
<form>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="tistoryID" aria-describedby="tistoryIDHelp">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="tistoryIDChk" aria-describedby="tistoryIDChkHelp">
    ...
    <div class="mb-4">
        ...
        <input type="email" class="form-control" id="tistoryInputEmail" >
        
    </div>
    <div class="mb-5 form-check">
        <input type="checkbox" class="form-check-input" id="tistoryAgree">
        <label class="form-check-label" for="tistoryAgree">백업 기능이 완전하지 않다는 사실을 확인합니다.</label>
    </div>
    <button type="button" class="btn btn-dark"  data-bs-toggle="modal" data-bs-target="#exampleModal">백업</button>
</form>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          티스토리 아이디 ${} 백업 후 이메일 주소 ${} 로 발송해드릴게요. 
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-dark" data-bs-dismiss="modal">닫기</button>
          <button type="button" class="btn btn-primary">백업 요청</button>
        </div>
      </div>
    </div>
  </div>
